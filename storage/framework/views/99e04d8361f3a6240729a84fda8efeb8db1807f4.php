            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <a href="<?php echo e(route('profile')); ?>" class="dropdown-item"><i class="bi-person-fill me-1"></i> My Profile</a>
                        <hr class="mb-2 mt-2">
                        <a class="dropdown-item text-danger" href="<?php echo e(route('logout')); ?>"
                           onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();"><i class="bi-lock-fill me-1"></i>
...
<?php /**PATH C:\DennisModul6\resources\views/layouts/nav.blade.php ENDPATH**/ ?>